...
<div id="addModal" class="modal" style="background-color: rgba(255, 255, 255, 0.8); backdrop-filter: blur(10px);">
    <div class="modal-content" style="font-size: 18px; padding: 20px; border-radius: 10px; border: 1px solid #ccc;">
        ...
        <form method="post" action="add_student.php">
            ...
            <input type="text" id="newStudentNumber" name="newStudentNumber" style="width: 100%; padding: 8px; margin-bottom: 15px; border-radius: 5px;"><br>
            <label for="newStudentName" style="color: #333;">Student Name:</label><br>
            <input type="text" id="newStudentName" name="newStudentName" style="width: 100%; padding: 8px; margin-bottom: 15px; border-radius: 5px;"><br>
            <label for="newEmail" style="color: #333;">Email:</label><br>
            <input type="text" id="newEmail" name="newEmail" style="width: 100%; padding: 8px; margin-bottom: 15px; border-radius: 5px;"><br>
            ...
            <input type="text" id="newUsername" name="newUsername" style="width: 100%; padding: 8px; margin-bottom: 15px; border-radius: 5px;"><br>
            <label for="newPassword" style="color: #333;">Password:</label><br>
            <input type="password" id="newPassword" name="newPassword" style="width: 100%; padding: 8px; margin-bottom: 15px; border-radius: 5px;"><br>
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<tr>
                        ...
                        <td>'.$password.'</td>
                        <td>
                            <button class="was-1" onclick="openEditModal('.$id.', \''.$newStudentNumber.'\', \''.$newStudentName.'\', \''.$newEmail.'\', \''.$newUserType.'\', \''.$username.'\', \''.$password.'\')">Edit</button>
                            <br><br>
